 ...
 * Use the [Kundun_shyguusu_Fragment.newInstance] factory method to
...
class Kundun_shyguusu_Fragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment Kundun_shyguusu_Fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            Kundun_shyguusu_Fragment().apply {
